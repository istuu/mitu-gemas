...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <style type="text/css">
      ...
      th, td, div, p {-webkit-font-smoothing: antialiased; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; font-size: 13px; line-height: 23px;  word-break: break-all; word-break: break-word;}
      ...
      @media only screen and (max-width: 699px) {
        ...
        .overlay-bg {background-image: url({{ $message->embed(asset('vendor/mailer/images/hero/overlay-dark.png')) }});}
      }
    </style>
  </head>
            ...
            <table class="row" align="center" bgcolor="#F4F4F4" cellpadding="0">
              ...
              <tr valign="top" style="vertical-align: top;">
                <th class="column mobile-12" width="520" style="padding: 0 90px; color: #232323; font-weight: 400;">
                  ...
                  <!-- <div style="font-size: 14px; margin-top: 45px;">Regards, <br><strong>ACS JAKARTA</strong></div> -->
                </th>
              </tr>
              <tr>
                <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
